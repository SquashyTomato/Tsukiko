...
module.exports = {
    ...
    async execute(client, config, msg, args, raw) {
        ...
        // API Request
        axios.get('http://danbooru.donmai.us/posts.json', { params: { random: 'true', tags: raw, limit: 100 } })
		    .then(function (response) {
                ...
                for (var i = data.length - 1; i >= 0; i--){
                    let tags = data[i].tag_string.split(' ');
		    ...
		    .catch(function (error) {
			    // If Cant Reach API
			    msg.channel.send('`Could not get image, is danbooru.donmai.us down?`');
		    });
    }
};