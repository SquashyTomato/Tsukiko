...
module.exports = {
    ...
    async execute(client, config, msg, args, raw) {
        ...
        // API Request
        axios.get('https://gelbooru.com/index.php', { params: { page: 'dapi', s: 'post', q: 'index', limit: 100, tags: raw, json: 1 } })
		    ...
		    .catch(function (error) {
			    // If Cant Reach API
			    msg.channel.send('`Could not get image, is gelbooru.com down?`');
		    });
    }
};