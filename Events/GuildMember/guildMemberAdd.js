    ...
    conn.getConnection(function (err, con) {
        con.query("SELECT * FROM `guilds` WHERE `id` = " + guildMember.guild.id, function (err, result) {
            ...
            if (!(guildMember.user.bot)) {
                ...
                if (!(result[0].alert_channel === null || result[0].alert_join === null)) {

                    // Replace Parts Of The String
                    let alertMessage = result[0].alert_join;
            ...
            if (!(result[0].log_channel === null || result[0].log_user === '1')) {
                ...
                const logEmbed = new Discord.MessageEmbed()
                    .setAuthor('User Joined', guildMember.user.avatarURL({ format: 'png', dynamic: true, size: 1024 }))
                    ...
                    .addField('Joined At', moment(guildMember.joinedTimestamp).format('MMMM Do YYYY, h:mm:ss A Z'), false)
